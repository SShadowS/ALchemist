...
### Fixed
- The Iteration Table no longer comes back blank after a window reload or restart. A `WebviewPanelSerializer` rehydrates the restored panel, which now shows a placeholder until the next run repopulates it.
